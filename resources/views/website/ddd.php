...
@section("contenu")
<h1><div class="shop-area pt-95 pb-100">
    <div class="container">
                                ...
                                <div class="col-xl-4 col-md-6 col-lg-6 col-sm-6">
                                    <div class="product-wrap mb-25 scroll-zoom">
                                        <div class="product-img">
                                            ...
                                            <div class="product-action">
                                                ...
                                                <div class="pro-same-action pro-cart">
                                                    <from methode="post" action="{{ route('panier.addtocart')}}">
                                                        @csrf
                                                    ...
                                                    <button typr="submit" title="Add To Cart" href="#"><i class="pe-7s-cart"></i> Add to cart</button>
                                                </from>
                                                </div>
                                        ...
                                        <div class="product-content text-center">
                                            <h3><a href="product-details.html"></a>{{ $product->name}}</h3>
