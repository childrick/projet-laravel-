    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-7">
                ...
                @if(Auth::check())
                <h3>Bienvenue Mr{{ Auth::user()->name}}</h3>
                Cliquer sur le bouton <b>Place Order</b> pour valider votre commande.
            ...
            <div class="col-lg-5">
                <div class="your-order-area">
                  ...
                  <li>
                        <span class="order-middle-left">{{ $product['name'] }}  X  {{ $product['qty'] }}</span>
                        <span class="order-price">{{ $product['price'] * $product['qty'] }}</span>
                 </li>
                     @php
