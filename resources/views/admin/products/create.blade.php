    ...
    <form id="quickForm" method="post" action="{{ route('products.store')}}" enctype="multipart/form-data">
      ...
      <div class="card-body">
        <div class="form-group">
          ...
          <input type="text" name="name"value="{{ old('name')}}" class="form-control @error("name") boeder-danger  @enderror" id="name" placeholder="entrer le nom du produit">
          @error("name")
        ...
        <div class="form-group">
            ...
            <textarea name="description" class="form-control @error("description") boeder-danger  @enderror" id="description" placeholder="entrer la description du produit">{{ old('description')}}</textarea>
            @error("description")
            <div class="text text-danger">{{ $message }}</div>
            @enderror
          </div>
          ...
          <div class="form-group">
            ...
            <input type="number" name="price"value="{{ old('price')}}" class="form-control @error("price") boeder-danger  @enderror" id="price" placeholder="entrer le prix du produit">
            @error("price")
            <div class="text text-danger">{{ $message }}</div>
            @enderror
          </div>
